...
export default async function PublicLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return (
    ...
    >
      ...
      {/* The one on-site control panel. Only a fully signed-in admin (password + MFA) gets it; visitors see published settings only. */}
      {isAdmin && <SiteSettingsPanel initialDraft={design} live={live} />}
    </div>
  );
}
